...
export default function IocpLinks(request) {
  return <Layout
    ...
    <body className="blog">
      <main>
        <p>
          ...
          >
            libuv
          </a>, which (among other things) provides a unified interface for
          asynchronous networking on the three big operating systems: Linux,
          OSX, and Windows.
        </p>

        <p className="date">March 2011</p>

        <h1>Asynchronous I/O in Windows for Unix Programmers</h1>

        <p>
          This document assumes you are familiar with how non-blocking socket
          I/O is done in Unix.
        </p>
        ...
        <p>
          ...
          high-concurrency programs are designed in Windows.
        </p>
        ...
        <p>
          The fundamental variation is that in a Unix you generally ask the
        ...
        <p>
          ...
          For example, one cannot poll on a regular file FD for readability
        ...
        <p>
          ...
          multiplexer&mdash;not POSIX AIO. Common practice for accessing the
          disk asynchronously is still done using custom userland thread
          pools&mdash;not POSIX AIO.
        </p>
      ...
      `}
       ...
       `}
        ...
        >
          <code>GetQueuedCompletionStatus()</code>
        </a>.

        <h3>Simple TCP Connection Example</h3>

        <p>
          To demonstrate the use of <code>GetQueuedCompletionStatus()</code>
          {" "}
          an example of connecting to <code>localhost</code>
      ...
      if (r == 0) {
        ...
        <p>
          Writing code that can take advantage of the best worlds on across Unix
          operating systems and Windows is very difficult, requiring one to
          understand intricate APIs and undocumented details from many different
          operating systems. There are several projects which have made attempts
          to provide an abstraction layer but in the author's opinion, none are
        ...
        <p>
          <b>
            <a
              href="http://www.boost.org/doc/libs/1_43_0/doc/html/boost_asio.html"
            >
              Boost ASIO
            </a>.
          </b>
          ...
          extremely difficult problem (~300 files, ~12000 semicolons).
        </p>
        ...
        TCP Sockets are by far the most important stream to get right. Servers
        ...
        <dl>
          ...
          <dd>
            Windows:
            <a
              href="http://msdn.microsoft.com/en-us/library/ms741688(v=VS.85).aspx"
            >
              {" "}
              <code>WSARecv()</code>
            </a>,
          ...
          <dd>
            ...
            <p>
              Non-blocking <code>connect()</code>
              is has difficult semantics in Unix. The proper way to connect to a
              remote host is this: call
          ...
          <dd>
            ...
            <p>
              The exact API of <code>sendfile(2)</code>
              on Unix has not been agreed on yet. Each operating system does it
              slightly different. All
              <code>sendfile(2)</code>
              implementations (except possibly FreeBSD?) are blocking even on
            ...
            <ul>
              <li>
                ...
                >
                  Linux <code>sendfile(2)</code>
                </a>
              </li>
              <li>
                <a
                  href="http://www.freebsd.org/cgi/man.cgi?query=sendfile&sektion=2"
                >
                  FreeBSD <code>sendfile(2)</code>
                </a>
              </li>
              <li>
                <a href="http://www.manpagez.com/man/2/sendfile/">
                  Darwin <code>sendfile(2)</code>
                </a>
              </li>
            </ul>
          ...
          <dt>
            <code>shutdown(2)</code>, graceful close, half-duplex connections
          </dt>
          <dd>
            <a
              href="http://msdn.microsoft.com/en-us/library/ms738547(v=VS.85).aspx"
            >
              Graceful Shutdown, Linger Options, and Socket Closure
            </a>
            <br />
            <a
              href="http://msdn.microsoft.com/en-us/library/ms737757(VS.85).aspx"
            >
              <code>DisconnectEx()</code>
            </a>
          </dd>
          ...
          <ul>
            <li>
              <a
                href="http://msdn.microsoft.com/en-us/library/ms740496(v=VS.85).aspx"
              >
                <code>sockaddr</code>
              </a>
            </li>
            <li>
              <a
                href="http://msdn.microsoft.com/en-us/library/ms737550(v=VS.85).aspx"
              >
                <code>bind()</code>
              </a>
            </li>
            <li>
              <a
                href="http://msdn.microsoft.com/en-us/library/ms738543(v=VS.85).aspx"
              >
        ...
        <dl>
          <dt>
            <code>socket(AF_Unix, SOCK_STREAM, 0), bind(2), listen(2)</code>
          </dt>
          <dd>
            <a
        ...
        <ul>
          <li>
            <a
              href="http://msdn.microsoft.com/en-us/library/aa365601(v=VS.85).aspx"
            >
          ...
          <li>
            <a
              href="http://msdn.microsoft.com/en-us/library/aa365603(v=VS.85).aspx"
            >
        ...
        <p>
          In Unix file system files are not able to use non-blocking I/O. There
          are some operating systems that have asynchronous I/O but it is not
          standard and at least on Linux is done with pthreads in GNU libc. For
          this reason applications designed to be portable across different
          Unixes must manage a thread pool for issuing file I/O syscalls.
        </p>

        <p>
          The situation is better in Windows: true overlapped I/O is available
          when reading or writing a stream of data to a file.
        </p>
        ...
        <p>
          ...
          readability or writablity just like a TCP socket&mdash;this is very
        ...
        <dl>
          ...
          <dt>
            <a
              href="http://www.kernel.org/doc/man-pages/online/pages/man3/tcsetattr.3.html"
            >
              <code>tcsetattr(3)</code>
            </a>
          </dt>
          <dd>
            <a
              href="http://msdn.microsoft.com/en-us/library/ms686033(VS.85).aspx"
            >
        ...
        <p>
          ...
          <ul>
            ...
            <li>
              <a
                href="http://msdn.microsoft.com/en-us/library/ms740673(VS.85).aspx"
              >
                <code>Windows Sockets 2</code>
              </a>
            </li>
          </ul>
        </p>
        ...
        <p>
          ...
          <ul>
            ...
            <ul>
              <li>
                <a
                  href="http://msdn.microsoft.com/en-us/library/ms683209(v=VS.85).aspx"
                >
                  <code>GetOverlappedResult()</code>
                </a>
              </li>
              <li>
                <a
                  href="http://msdn.microsoft.com/en-us/library/ms683244(v=VS.85).aspx"
                >
                  <code>HasOverlappedIoCompleted()</code>
                </a>
              </li>
              <li>
                <a
            ...
            <li id="setmaxstdio">
              <a href="http://msdn.microsoft.com/en-us/library/6e3b887c.aspx">
                <code>
                  _setmaxstdio()
                </code>
              </a>
        ...
        <p>
          ...
          <ul>
            <li>
              <a
                href="http://msdn.microsoft.com/en-us/library/ms681951(v=vs.85).aspx"
              >
        ...
        <ul>
          <li>
            <a
              href="http://msdn.microsoft.com/en-us/library/aa365781(v=VS.85).aspx"
            >
              <code>Pipe functions</code>
            </a>
          </li>
          <li>
            <a
        ...
        Also useful:{" "}
        <a
          href="http://msdn.microsoft.com/en-us/library/xw1ew2f8(v=vs.80).aspx"
        >
        ...
        <br />
        <a
          href="http://ebookbrowse.com/network-programming-for-microsoft-windows-2nd-edition-2002-pdf-d73663829"
        >
          Network Programming For Microsoft Windows 2nd Edition 2002
        </a>. Juicy details on page 119.
      </main>
    </body>
  </Layout>;
}
